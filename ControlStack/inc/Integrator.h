...
public:
  ...
  void populate_data(Hopper &hopper, const vector_t &q_k, 
                        const vector_t &v_k, const vector_t &a, const domain &d, vector_ht &x_dot, matrix_t &A, matrix_t &B, matrix_t &C);

  void x_integrator(Hopper &hopper, const matrix_t &A, const vector_t &x_dot, const vector_t& q_k,
  ...
  void xpj_integrator(Hopper &hopper, const vector_t &x_k, const vector_t p_k, const scalar_t J_k, const vector_4t &u_k, 
