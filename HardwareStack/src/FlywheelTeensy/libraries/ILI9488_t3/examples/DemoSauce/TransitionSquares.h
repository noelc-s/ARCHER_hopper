...
void TransitionSquares::init( ILI9488_t3 tft ) {

}

void TransitionSquares::restart( ILI9488_t3 tft, uint_fast16_t inColor ) {
...
void TransitionSquares::perFrame( ILI9488_t3 tft, FrameParams frameParams ) {
