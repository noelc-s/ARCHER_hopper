 ...
 */
MBEDTLSFLASHMEM static inline void chacha20_quarter_round( uint32_t state[16],
                                           size_t a,
                                           size_t b,
                                           size_t c,
                                           size_t d )
 ...
 */
MBEDTLSFLASHMEM static void chacha20_inner_block( uint32_t state[16] )
{
 ...
 */
MBEDTLSFLASHMEM static void chacha20_block( const uint32_t initial_state[16],
...
MBEDTLSPROGMEM static const unsigned char test_keys[2][32] =
{
    {
...
MBEDTLSPROGMEM static const unsigned char test_nonces[2][12] =
{
    {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00
...
MBEDTLSPROGMEM static const uint32_t test_counters[2] =
{
    0U,
    1U
};

MBEDTLSPROGMEM static const unsigned char test_input[2][375] =
{
    {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
MBEDTLSPROGMEM static const unsigned char test_output[2][375] =
{
    {
...
MBEDTLSPROGMEM static const size_t test_lengths[2] =
{
    64U,
    375U
};
