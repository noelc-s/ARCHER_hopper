...
MBEDTLSFLASHMEM static uint64_t mul64( uint32_t a, uint32_t b )
{
...
#else
MBEDTLSFLASHMEM static inline uint64_t mul64( uint32_t a, uint32_t b )
{
    return( (uint64_t) a * b );
}
#endif
 ...
 */
MBEDTLSFLASHMEM static void poly1305_process( mbedtls_poly1305_context *ctx,
                              size_t nblocks,
 ...
 */
MBEDTLSFLASHMEM static void poly1305_compute_mac( const mbedtls_poly1305_context *ctx,
...
MBEDTLSPROGMEM static const unsigned char test_data[2][127] =
{
    {
...
MBEDTLSPROGMEM static const size_t test_data_len[2] =
{
    34U,
    127U
};

MBEDTLSPROGMEM static const unsigned char test_mac[2][16] =
{
    {
