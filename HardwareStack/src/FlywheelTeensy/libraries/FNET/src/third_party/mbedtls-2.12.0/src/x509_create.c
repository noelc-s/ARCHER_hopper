...
MBEDTLSPROGMEM static const x509_attr_descriptor_t x509_attrs[] =
{
...
MBEDTLSFLASHMEM static const char *x509_at_oid_from_name( const char *name, size_t name_len )
{
 ...
 */
MBEDTLSFLASHMEM static int x509_write_name( unsigned char **p, unsigned char *start,
...
MBEDTLSFLASHMEM static int x509_write_extension( unsigned char **p, unsigned char *start,
