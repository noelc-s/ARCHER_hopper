 ...
 */
MBEDTLSPROGMEM static const int ciphersuite_preference[] =
{
...
MBEDTLSPROGMEM static const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
...
MBEDTLSFLASHMEM const mbedtls_ssl_ciphersuite_t *mbedtls_ssl_ciphersuite_from_string(
...
MBEDTLSFLASHMEM const mbedtls_ssl_ciphersuite_t *mbedtls_ssl_ciphersuite_from_id( int ciphersuite )
{
    const mbedtls_ssl_ciphersuite_t *cur = ciphersuite_definitions;
