 ...
 */
MBEDTLSFLASHMEM static inline void aria_a( uint32_t *a, uint32_t *b,
 ...
 */
MBEDTLSFLASHMEM static inline void aria_sl( uint32_t *a, uint32_t *b,
                            uint32_t *c, uint32_t *d,
 ...
 * S-Boxes
 */
MBEDTLSPROGMEM static const uint8_t aria_sb1[256] =
{
...
MBEDTLSPROGMEM static const uint8_t aria_sb2[256] =
{
...
MBEDTLSPROGMEM static const uint8_t aria_is1[256] =
{
...
MBEDTLSPROGMEM static const uint8_t aria_is2[256] =
{
 ...
 */
MBEDTLSFLASHMEM static void aria_fo_xor( uint32_t r[4], const uint32_t p[4],
 ...
 */
MBEDTLSFLASHMEM static void aria_fe_xor( uint32_t r[4], const uint32_t p[4],
                         const uint32_t k[4], const uint32_t x[4] )
{
    uint32_t a, b, c, d;
 ...
 */
MBEDTLSFLASHMEM static void aria_rot128( uint32_t r[4], const uint32_t a[4],
 ...
 */
MBEDTLSPROGMEM static const uint8_t aria_test1_ecb_key[32] =           // test key
{
...
MBEDTLSPROGMEM static const uint8_t aria_test1_ecb_pt[MBEDTLS_ARIA_BLOCKSIZE] =            // plaintext
{
    0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,     // same for all
    0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF      // key sizes
};

MBEDTLSPROGMEM static const uint8_t aria_test1_ecb_ct[3][MBEDTLS_ARIA_BLOCKSIZE] =         // ciphertext
{
...
MBEDTLSPROGMEM static const uint8_t aria_test2_key[32] =
{
...
MBEDTLSPROGMEM static const uint8_t aria_test2_pt[48] =
{
...
#if (defined(MBEDTLS_CIPHER_MODE_CBC) || defined(MBEDTLS_CIPHER_MODE_CFB))
MBEDTLSPROGMEM static const uint8_t aria_test2_iv[MBEDTLS_ARIA_BLOCKSIZE] =
{
...
#if defined(MBEDTLS_CIPHER_MODE_CBC)
MBEDTLSPROGMEM static const uint8_t aria_test2_cbc_ct[3][48] =         // CBC ciphertext
{
...
#if defined(MBEDTLS_CIPHER_MODE_CFB)
MBEDTLSPROGMEM static const uint8_t aria_test2_cfb_ct[3][48] =         // CFB ciphertext
{
...
#if defined(MBEDTLS_CIPHER_MODE_CTR)
MBEDTLSPROGMEM static const uint8_t aria_test2_ctr_ct[3][48] =         // CTR ciphertext
{
