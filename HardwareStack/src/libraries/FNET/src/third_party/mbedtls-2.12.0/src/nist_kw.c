...
MBEDTLSFLASHMEM static inline unsigned char mbedtls_nist_kw_safer_memcmp( const void *a, const void *b, size_t n )
{
    size_t i;
...
MBEDTLSPROGMEM static const unsigned char NIST_KW_ICV1[] = {0xA6, 0xA6, 0xA6, 0xA6, 0xA6, 0xA6, 0xA6, 0xA6};
/*! The 32-bit default integrity check value (ICV) for KWP mode. */
MBEDTLSPROGMEM static const  unsigned char NIST_KW_ICV2[] = {0xA6, 0x59, 0x59, 0xA6};
 ...
 */
MBEDTLSFLASHMEM static void calc_a_xor_t( unsigned char A[KW_SEMIBLOCK_LENGTH], uint64_t t )
{
    size_t i = 0;
 ...
 */
MBEDTLSFLASHMEM int mbedtls_nist_kw_wrap( mbedtls_nist_kw_context *ctx,
 ...
 */
MBEDTLSFLASHMEM static int unwrap( mbedtls_nist_kw_context *ctx,
 ...
 */
MBEDTLSFLASHMEM int mbedtls_nist_kw_unwrap( mbedtls_nist_kw_context *ctx,
                            mbedtls_nist_kw_mode_t mode,
                            const unsigned char *input, size_t in_len,
                            unsigned char *output, size_t *out_len, size_t out_size )
{
 ...
 */
MBEDTLSPROGMEM static const unsigned int key_len[KW_TESTS] = { 16, 24, 32 };

MBEDTLSPROGMEM static const unsigned char kw_key[KW_TESTS][32] = {
...
MBEDTLSPROGMEM static const unsigned char kw_msg[KW_TESTS][40] = {
...
MBEDTLSPROGMEM static const size_t kw_msg_len[KW_TESTS] = { 16, 40, 24 };
MBEDTLSPROGMEM static const size_t kw_out_len[KW_TESTS] = { 24, 48, 32 };
MBEDTLSPROGMEM static const unsigned char kw_res[KW_TESTS][48] = {
...
MBEDTLSPROGMEM static const unsigned char kwp_key[KW_TESTS][32] = {
...
MBEDTLSPROGMEM static const unsigned char kwp_msg[KW_TESTS][31] = {
...
MBEDTLSPROGMEM static const size_t kwp_msg_len[KW_TESTS] = { 9, 31, 1 };

MBEDTLSPROGMEM static const unsigned char kwp_res[KW_TESTS][48] = {
...
MBEDTLSPROGMEM static const size_t kwp_out_len[KW_TESTS] = { 24, 40, 16 };
