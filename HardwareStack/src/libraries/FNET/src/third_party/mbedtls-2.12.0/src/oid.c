...
MBEDTLSFLASHMEM static const TYPE_T * oid_ ## NAME ## _from_asn1( const mbedtls_asn1_buf *oid )     \
{                                                                           \
    const TYPE_T *p = LIST;                                                 \
...
MBEDTLSFLASHMEM int FN_NAME( const mbedtls_asn1_buf *oid, ATTR1_TYPE * ATTR1 )                  \
{                                                                       \
...
#define FN_OID_GET_ATTR2(FN_NAME, TYPE_T, TYPE_NAME, ATTR1_TYPE, ATTR1,     \
                         ATTR2_TYPE, ATTR2)                                 \
MBEDTLSFLASHMEM int FN_NAME( const mbedtls_asn1_buf *oid, ATTR1_TYPE * ATTR1, ATTR2_TYPE * ATTR2 )  \
{                                                                           \
    const TYPE_T *data = oid_ ## TYPE_NAME ## _from_asn1( oid );            \
    if( data == NULL ) return( MBEDTLS_ERR_OID_NOT_FOUND );                \
    *ATTR1 = data->ATTR1;                                                   \
...
MBEDTLSFLASHMEM int FN_NAME( ATTR1_TYPE ATTR1, const char **oid, size_t *olen )             \
{                                                                           \
...
#define FN_OID_GET_OID_BY_ATTR2(FN_NAME, TYPE_T, LIST, ATTR1_TYPE, ATTR1,   \
                                ATTR2_TYPE, ATTR2)                          \
MBEDTLSFLASHMEM int FN_NAME( ATTR1_TYPE ATTR1, ATTR2_TYPE ATTR2, const char **oid ,         \
             size_t *olen )                                                 \
{                                                                           \
    const TYPE_T *cur = LIST;                                               \
    while( cur->descriptor.asn1 != NULL ) {                                 \
...
MBEDTLSPROGMEM static const oid_x520_attr_t oid_x520_attr_type[] =
{
    {
...
MBEDTLSPROGMEM static const oid_x509_ext_t oid_x509_ext[] =
{
    {
...
MBEDTLSPROGMEM static const mbedtls_oid_descriptor_t oid_ext_key_usage[] =
{
...
MBEDTLSPROGMEM static const oid_sig_alg_t oid_sig_alg[] =
{
...
MBEDTLSPROGMEM static const oid_pk_alg_t oid_pk_alg[] =
{
    {
...
MBEDTLSPROGMEM static const oid_ecp_grp_t oid_ecp_grp[] =
{
...
MBEDTLSPROGMEM static const oid_cipher_alg_t oid_cipher_alg[] =
{
    {
...
MBEDTLSPROGMEM static const oid_md_alg_t oid_md_alg[] =
{
#if defined(MBEDTLS_MD2_C)
    {
...
MBEDTLSPROGMEM static const oid_md_hmac_t oid_md_hmac[] =
{
#if defined(MBEDTLS_SHA1_C)
    {
...
MBEDTLSPROGMEM static const oid_pkcs12_pbe_alg_t oid_pkcs12_pbe_alg[] =
{
    {
...
MBEDTLSFLASHMEM int mbedtls_oid_get_numeric_string( char *buf, size_t size,
